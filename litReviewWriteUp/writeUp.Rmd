...
A \emph{cartridge case} is the part of firearm ammunition that encases a projectile (e.g., bullet, shots, or slug) along with the explosive used to propel the projectile through the firearm. 
...
# Improving the Cartridge Case Analysis Pipeline
